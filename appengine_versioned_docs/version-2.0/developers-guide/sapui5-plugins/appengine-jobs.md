...
Configured Background processing. Described here: [Configuration and Administration -> Background processing](../../../version-2.0/administrators-guide/configuration-and-administration/overview.md).
