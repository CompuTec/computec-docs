...
| Improvement | Weighing Process | New settings: Range from mode, Confirm each weighting, Is precision Weight Enabled for Weighting. Click [this link](/docs/pdc/administrator-guide/setting-up-the-application/overview#computec-processforce-settings) to find out more | – |
...
| Improvement | Tasks | Downtime 2.0. Click [this link](/docs/pdc/user-guide/task-activities/downtime) to find out more | 2.93.12.1 (2.10.1.0), <br/>3.93.12.1 (3.10.1.0) | - |
