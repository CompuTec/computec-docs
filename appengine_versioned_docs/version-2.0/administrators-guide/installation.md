...
1. Run the installation file (CompuTec AppEngine) from the [Download](/docs/appengine/2.0/releases/appengine/download) section and click "Install" in the opened installation Wizard.
