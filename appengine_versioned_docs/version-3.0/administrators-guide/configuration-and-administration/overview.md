...
2. Entering the following web address in a browser `localhost:54001` - 54001 is a default port set for connection; it can be changed in the [Settings section](#settings).
