...
| Improved | Manufacturing Order | Added an option in **General Settings** > **ProcessForce** > **General** to support **Snapshot Isolation** to improve system stability and reduce blocking during high-volume operations. |
