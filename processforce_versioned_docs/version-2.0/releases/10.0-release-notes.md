...
| Improved | Manufacturing Order | Added **Snapshot Isolation** option in **SAP Business One** > **Administration** > **System Initialization** > **General Settings** > **ProcessForce** > **General** to improve system stability and reduce blocking during high-volume operations. [Read more](/docs/processforce/2.0/troubleshooting/performance-issues#snapshot-isolation-in-sap-business-one-sql-server) |
