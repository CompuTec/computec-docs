...
- Employees connected to the downtime:
  ...
  - Technician: the person responsible for the defect removal. Click [here](/docs/pdc/administrators-guide/setting-up-the-application/overview#requirements) to find out more.
