...
It is possible to incorporate [User-Defined Fields (UDFs)](https://learn.computec.one/docs/processforce/administrator-guide/udfs/working-with-user-defined-fields.md) into formulas, using both header or row UDFs.

:::note

- The formula result is a numeric value. Therefore any [User-Defined Fields](https://learn.computec.one/docs/processforce/administrator-guide/udfs/working-with-user-defined-fields.md) used in the formula should be created with a Numeric data type.
