...
It is possible to incorporate [User-Defined Fields (UDFs)](/docs/processforce/administrator-guide/udfs/working-with-user-defined-fields) into formulas, using both header or row UDFs.

:::note

- The formula result is a numeric value. Therefore any [User-Defined Fields](/docs/processforce/administrator-guide/udfs/working-with-user-defined-fields) used in the formula should be created with a Numeric data type.
