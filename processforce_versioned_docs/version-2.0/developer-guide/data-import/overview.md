...
:::info
    On the 4th of March 2022, [PFI (CompuTec ProcessForce Import) plugin for CompuTec AppEngine](/docs/processforce/plugins-user-guide/pfi) was released. PFI facilitates the import and updating of data to CompuTec ProcessForce objects, providing a streamlined, faster, and more flexible alternative to PowerShell updates.
:::
