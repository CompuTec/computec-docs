...
:::danger
    ...
    Before the installation, you have to navigate to **SAP Business One** > **Administration** > **System Initialization** > **General Settings** > **Services**, and disable **Enable Query Validation** for both the **UI API** and **DI API**.
        ...
        :::info[note]
        **CompuTec ProcessForce** does not currently support the **Enable Query Validation** option. If either setting is enabled, you may see an error durings the **CompuTec ProcessForce** installation.
:::
