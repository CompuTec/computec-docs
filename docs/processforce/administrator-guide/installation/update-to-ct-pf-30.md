...
To update to CompuTec ProcessForce 3.0 for the [standard environment](/docs/processforce/administrator-guide/installation/update-to-ct-pf-30#scenario-1-standard-environment), follow these steps:
