...
➡️ For a detailed description of each option available on this tab, refer to the official [CompuTec PDC Documentation](/docs/pdc/administrators-guide/setting-up-the-application/overview#processforce-settings).
