...
Formulas can include [User-Defined Fields (UDFs)](https://learn.computec.one/docs/processforce/administrator-guide/udfs/working-with-user-defined-fields.md) from both the header and line levels.
