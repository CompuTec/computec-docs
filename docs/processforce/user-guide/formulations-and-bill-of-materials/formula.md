...
Formulas can include [User-Defined Fields (UDFs)](/docs/processforce/administrator-guide/udfs/working-with-user-defined-fields) from both the header and line levels.
