...
2. Follow the detailed instructions to install the plugin on your SAP Business One system descibed in [this guide](/docs/appengine/plugins-user-guide/install-plugin)
