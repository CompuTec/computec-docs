...
| Improved | Quality Control | Added a **General Settings** option to automatically validate or create **Quality Control Tests** when an operation status changes. [Read more](http://learn.computec.one/docs/processforce/user-guide/quality-control/automatic-creation-of-quality-control-documents#validate-or-create-quality-control-tests-on-operation-status-change) |
