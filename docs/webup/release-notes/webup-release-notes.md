...
| Improved | Improved **Content Security Policy (CSP)** handling for **SAP Business One Web Client** environments. |
...
| Improved | Introduced new script editor for **View Actions**, improving readability and editing experience for scripts. [Read more](https://microsoft.github.io/monaco-editor/) |
