...
1. To install the CompuTec PDC application, download and run its [installation file](https://learn.computec.one/docs/appengine/releases/plugins/pdc/download) – CompuTec.PDC.Setup.x64.msi.
