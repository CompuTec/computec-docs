...
:::info
    ...
    CompuTec PDC is now compatible with CompuTec AppEngine. For configuration details, please refer to the following link: [CompuTec AppEngine Plugin Configuration Manual](/docs/pdc/pdc-plugin/computec-pdc-plugin).
:::

CompuTec PDC is now available to work with CompuTec AppEngine. For details of configuration, please follow this link: [CompuTec PDC Plugin](/docs/pdc/pdc-plugin/computec-pdc-plugin).
