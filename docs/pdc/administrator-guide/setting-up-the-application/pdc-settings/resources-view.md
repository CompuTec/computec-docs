...
To use this feature, you need the CompuTec AppEngine's MO360 plugin. For more details on CompuTec AppEngine and the plugin installation process, click [this link](/docs/pdc/manufacturing-order-360/plugin-installation-and-configuration).
