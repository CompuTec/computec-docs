...
| Bug | Server | The antivirus program incorrectly flags a WMS server file, even when project optimization is not disabled. |
| Bug | Server | Old Stock Counting causes locks. |
...
| Bug | Client | Delivery: SU Status validation merged in Core version. |
