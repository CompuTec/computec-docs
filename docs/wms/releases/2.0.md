...
| --- | --- | --- | --- |
| Improvement | Client | Stock Transfer - selected item is now on top, instead of the bottom of the list. | - |
| Improvement | Custom Configuration | UDF Manager - possibility to change the sequence of the fields | - |
| Improvement | Client Android | WMS Client (new) - possibility to enable biger labels for transactions | - |
| Improvement | Client Android | Bigger field for Quantity | - |
| Improvement | Client | Barcode Decoder - possibility to change the sequence of the rules | - |
| Improvement | Client | Possibility to scanning barcode for UoM on the Quantity screen for GRPO, Delivery, Stock Transfer and Pick and Pack | - |
| Improvement | Server | WMS Server - now is possible to use SQL server 2022 | - |
| Improvement | Custom Configuration | Stock Transfer - added option in CC to move only content of SU | - |
...
| Bug | Client | Pick and Pack: After deleting a line from a Sales Prder, an error message appeared when attempting to open a Pick List from that Sales Order <br/><br/> The error message: <blockquote>Error Message: Invalid Row.</blockquote> | SWMS-3484 |
