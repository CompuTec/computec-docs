...
| Bug | Client | Pick and Pack: After deleting a line from a Sales Prder, an error message appeared when attempting to open a Pick List from that Sales Order <br/><br/> The error message: <blockquote>Invalid Row.</blockquote> | SWMS-3484 |
