...
| Added | Scanners | Added support for **Bluebird** scanners. The scanner input mode can be selected in the **Scanner** settings. [Read more](/docs/wms/administrator-guide/installation/wms-client/computec-wms-android-version#configure-scanning-on-bluebird-devices) |
