...
Click [here](/docs/appengine/2.0/releases/plugins/wms-stock-counting/download) to get AppEngine plugin for Stock Counting and Compatibility Tools.
...
<table>
  ...
  <tr>
    ...
    <td>2.10.23 R1 64-bit version</td>
    <td rowspan="5">2.10.23.1</td>
    <td><a href="https://download.computec.one/software/wms/server/releases/CompuTec_WMS_Server_2.10.23.1_x64.exe">Download</a></td>
    <td>
      <ul>
        <li>
          ...
          <ul>
            ...
            <li>ProcessForce from 10.0 R1 to 10.0 (R29) HF1</li>
  ...
  <tr>
    ...
    <td>-</td>
    <td><a href="https://download.computec.one/software/wms/client/windows/releases/CompuTec_WMS_Client_2.10.23.1.msi">Download</a></td>
    <td>-</td>
  </tr>
  <tr>
    <td>CompuTec WMS Client Windows Desktop (legacy)</td>
    <td>-</td>
    <td><a href="https://download.computec.one/software/wms/client/windows/releases/CompuTec_WMS_Client_Legacy_2.10.23.1.msi">Download</a></td>
    <td>-</td>
  </tr>
  <tr>
    <td>CompuTec WMS Client Windows CE</td>
    <td>-</td>
    <td><a href="https://download.computec.one/software/wms/client/ce/releases/CompuTec_WMS_Client_2.10.23.1.cab">Download</a></td>
    <td>-</td>
  </tr>
  <tr>
    <td>CompuTec WMS Client Android</td>
    <td>-</td>
    <td><a href="https://download.computec.one/software/wms/client/android/releases/CompuTec_WMS_Client_2.10.23.1.apk">Download</a></td>
    <td>-</td>
  </tr>
</table>
...
<table>
  ...
  <tr>
    ...
    <td>2.9.23 R1 32-bit version</td>
    <td rowspan="5">2.9.23.1</td>
    <td><a href="https://download.computec.one/software/wms/server/releases/CompuTec_WMS_Server_2.9.23.1_x86.exe">Download</a></td>
    <td>
      <ul>
        <li>
          <p>For CompuTec WMS to work with SAP Business One and ProcessForce:</p>
  ...
  <tr>
    <td>2.9.23 R1 64-bit version</td>
    <td><a href="https://download.computec.one/software/wms/server/releases/CompuTec_WMS_Server_2.9.23.1_x64.exe">Download</a></td>
    <td>
      <ul>
        <li>
          <p>For CompuTec WMS to work with SAP Business One and ProcessForce:</p>
  ...
  <tr>
    ...
    <td>-</td>
    <td><a href="https://download.computec.one/software/wms/client/windows/releases/CompuTec_WMS_Client_2.9.23.1.msi">Download</a></td>
    <td>-</td>
  </tr>
  <tr>
    <td>CompuTec WMS Client Windows CE</td>
    <td>-</td>
    <td><a href="https://download.computec.one/software/wms/client/ce/releases/CompuTec_WMS_Client_2.9.23.1.cab">Download</a></td>
    <td>-</td>
  </tr>
</table>*/}
