...
:::info
    Before installing the CompuTec WMS Handheld Device Client, you must first have the CompuTec WMS server installed. Click [here](/docs/wms/administrator-guide/installation/wms-server/overview) for more information on server installation.
:::
