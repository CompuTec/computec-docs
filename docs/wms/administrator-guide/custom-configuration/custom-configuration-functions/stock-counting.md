...
![Stock Counting](./media/cc-stock-counting1.png)
...
- **Hide save button** - Hides the Save button from the Stock Counting screen in the WMS Client. When enabled, users will not be able to manually save the document from the standard interface.

    ![Hide save button](./media/hide-save-button.png)

- **Hide preview button** - Hides the Preview button from the Stock Counting screen. This removes the ability to open the Preview List before saving the document.

    ![Hide preview button](./media/hide-preview-button.png)

- **Always display Preview List on Document Details screen** - Automatically opens and displays the Preview List when entering the Document Details screen. This ensures users always see the preview of counted items without needing to manually open it.

- **Force manual quantity confirmation** - Requires the user to manually confirm the entered quantity during Stock Counting.
