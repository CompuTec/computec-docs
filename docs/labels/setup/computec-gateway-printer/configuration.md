...
The CompuTec Gateway Manager can be downloaded from the following page. [Click here to navigate to the page](/docs/labels/releases/download/#computec-gateway-manager).
