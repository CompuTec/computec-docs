...
| Improved | Printing Manager Application | Improved **Request Details** performance and usability. Request details now load faster without requiring SAP Business One company credentials, and the details pane remains docked at the bottom of the screen. [Read more](/docs/labels/setup/requests/review-requests) |
