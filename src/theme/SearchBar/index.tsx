        ...
        props.transformItems
          ...
          items.map((item) => {
            ...
            if (projectName && projectNameMap[projectName]) {
              ...
              if (projectNameMapWithoutCompuTec[projectName] === currentValue) {
                item._highlightResult.hierarchy.lvl0.value = `${projectDisplayName}`;
              } else {
                item._highlightResult.hierarchy.lvl0.value = `${projectDisplayName} > ${currentValue}`;
              }
            }
